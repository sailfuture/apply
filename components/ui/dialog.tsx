  ...
  return (
    <DialogPortal>
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          // max-h + overflow-y so a dialog taller than the viewport
          // scrolls internally instead of clipping unreachably (the
          // overlay locks body scroll). Consumers that manage their own
          // scrolling still win via twMerge.
...
function DialogHeader({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      // pr-6 keeps long titles clear of the absolute-positioned close
      // button in the dialog's top-right corner.
